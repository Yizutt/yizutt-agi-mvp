...
- `web/panel/index.html` is the Codex-style browser workbench, with a history/queue activity rail, task stream composer, Runtime inspector, live trace output, and saved history replay.
