...
| 全局 CLI | `python/yizutt_agi/cli.py` | `yizutt` 入口，裸命令默认启动本地 Runtime/Web 工作台，并分发 `setup`、`onboard`、`gateway`、`skill`、`start` 等子命令 |
